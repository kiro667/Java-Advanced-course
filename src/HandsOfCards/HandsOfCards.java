...
public class HandsOfCards {
        ...
        while(true){
            ...
            for (Map.Entry<String,Set<String>> player : players.entrySet()) {
                ...
                for (String card : player.getValue()) {
                    ...
                    totalCardsStrength +=  getComputeCardStrength(types, powers, power, type);
    ...
    private static int getComputeCardStrength(Map<String, Integer> types, Map<String, Integer> powers, String power, String type) {
